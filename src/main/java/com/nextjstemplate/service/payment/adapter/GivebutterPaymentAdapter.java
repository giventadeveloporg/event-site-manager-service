...
import com.nextjstemplate.service.payment.adapter.givebutter.dto.GivebutterDonationRequest;
import com.nextjstemplate.service.payment.adapter.givebutter.dto.GivebutterDonationResponse;
...
public class GivebutterPaymentAdapter implements PaymentService {
    ...
    public Map<String, Object> handleWebhook(String payload, String signature, Map<String, Object> providerConfig) throws PaymentException {
        ...
        try {
            ...
            com.nextjstemplate.service.payment.adapter.givebutter.dto.GivebutterWebhookEvent event = objectMapper.readValue(
                payload,
                com.nextjstemplate.service.payment.adapter.givebutter.dto.GivebutterWebhookEvent.class
            );
