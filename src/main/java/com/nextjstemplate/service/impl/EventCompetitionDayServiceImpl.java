...
public class EventCompetitionDayServiceImpl implements EventCompetitionDayService {
    ...
    public EventCompetitionDayServiceImpl(EventCompetitionDayRepository eventCompetitionDayRepository, EventCompetitionDayMapper eventCompetitionDayMapper) {
    ...
    public EventCompetitionDayDTO save(EventCompetitionDayDTO eventCompetitionDayDTO) {
        ...
        if (entity.getId() != null) {
            log.warn("EventCompetitionDay has ID {} set during create operation. Clearing ID to force sequence generation.", entity.getId());
            entity.setId(null);
        }
