...
public class EventCompetitionSettingsServiceImpl implements EventCompetitionSettingsService {
    ...
    public EventCompetitionSettingsServiceImpl(EventCompetitionSettingsRepository eventCompetitionSettingsRepository, EventCompetitionSettingsMapper eventCompetitionSettingsMapper) {
    ...
    public EventCompetitionSettingsDTO save(EventCompetitionSettingsDTO eventCompetitionSettingsDTO) {
        ...
        if (entity.getId() != null) {
            log.warn("EventCompetitionSettings has ID {} set during create operation. Clearing ID to force sequence generation.", entity.getId());
            entity.setId(null);
        }
