...
import com.nextjstemplate.service.EventCompetitionParticipantQueryService;
...
public class EventCompetitionParticipantResource {
    ...
    public EventCompetitionParticipantResource(EventCompetitionParticipantService eventCompetitionParticipantService, EventCompetitionParticipantRepository eventCompetitionParticipantRepository, EventCompetitionParticipantQueryService eventCompetitionParticipantQueryService) {
    ...
    @PostMapping("")
    public ResponseEntity<EventCompetitionParticipantDTO> create(@Valid @RequestBody EventCompetitionParticipantDTO dto) throws URISyntaxException {
        if (dto.getId() != null) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<EventCompetitionParticipantDTO> update(@PathVariable(value = "id", required = false) final Long id, @Valid @RequestBody EventCompetitionParticipantDTO dto) throws URISyntaxException {
        if (dto.getId() == null) {
        ...
        return ResponseEntity.ok().headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, dto.getId().toString())).body(eventCompetitionParticipantService.update(dto));
    }

    @PatchMapping(value = "/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<EventCompetitionParticipantDTO> partialUpdate(@PathVariable(value = "id", required = false) final Long id, @NotNull @RequestBody EventCompetitionParticipantDTO dto) throws URISyntaxException {
        if (dto.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(id, dto.getId())) {
    ...
    @GetMapping("")
    public ResponseEntity<List<EventCompetitionParticipantDTO>> getAll(EventCompetitionParticipantCriteria criteria, @org.springdoc.core.annotations.ParameterObject Pageable pageable) {
