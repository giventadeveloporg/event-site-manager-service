...
import com.nextjstemplate.repository.GivebutterWebhookEventRepository;
...
import com.nextjstemplate.service.payment.orchestration.PaymentOrchestrationService;
import com.nextjstemplate.service.payment.webhook.GivebutterWebhookRateLimitService;
...
public class GivebutterWebhookController {
    ...
    public ResponseEntity<?> handleWebhook(
        ...
        com.nextjstemplate.service.payment.adapter.givebutter.dto.GivebutterWebhookEvent event = null;
        GivebutterWebhookEvent webhookEvent = null;
        String eventId = null;

        try {
            // Parse webhook payload to extract tenant_id
            event = objectMapper.readValue(payload, com.nextjstemplate.service.payment.adapter.givebutter.dto.GivebutterWebhookEvent.class);
     ...
     */
    private String generateEventId(com.nextjstemplate.service.payment.adapter.givebutter.dto.GivebutterWebhookEvent event) {
    ...
    private GivebutterWebhookEvent saveWebhookEvent(
        String eventId,
        com.nextjstemplate.service.payment.adapter.givebutter.dto.GivebutterWebhookEvent eventDTO,
        String payload
    ) {
     ...
     */
    private String extractTenantId(com.nextjstemplate.service.payment.adapter.givebutter.dto.GivebutterWebhookEvent event) {
