...
public class EventCompetitionParticipant implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eventCompetitionParticipantSeq")
    @SequenceGenerator(
        name = "eventCompetitionParticipantSeq",
        sequenceName = "public.event_competition_participant_id_seq",
        allocationSize = 1
    )
    @Column(name = "id")
    private Long id;
