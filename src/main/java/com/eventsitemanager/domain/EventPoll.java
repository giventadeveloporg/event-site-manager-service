...
public class EventPoll implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eventPollSeq")
    @SequenceGenerator(name = "eventPollSeq", sequenceName = "public.event_poll_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
