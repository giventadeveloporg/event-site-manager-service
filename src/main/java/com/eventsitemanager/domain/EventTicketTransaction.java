...
public class EventTicketTransaction implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eventTicketTransactionSeq")
    @SequenceGenerator(name = "eventTicketTransactionSeq", sequenceName = "public.event_ticket_transaction_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
    ...
    public EventTicketTransaction netPayoutAmount(BigDecimal netPayoutAmount) {
        this.setNetPayoutAmount(netPayoutAmount);
        return this;
    }
