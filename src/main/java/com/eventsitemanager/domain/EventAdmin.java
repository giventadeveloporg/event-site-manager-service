...
public class EventAdmin implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eventAdminSeq")
    @SequenceGenerator(name = "eventAdminSeq", sequenceName = "public.event_admin_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
