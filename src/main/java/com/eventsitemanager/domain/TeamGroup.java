...
public class TeamGroup implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "teamGroupsSeq")
    @SequenceGenerator(name = "teamGroupsSeq", sequenceName = "public.team_groups_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
