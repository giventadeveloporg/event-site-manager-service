...
public class EventScoreCardDetail implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eventScoreCardDetailSeq")
    @SequenceGenerator(name = "eventScoreCardDetailSeq", sequenceName = "public.event_score_card_detail_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
