...
public class EventSponsors implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eventSponsorsSeq")
    @SequenceGenerator(name = "eventSponsorsSeq", sequenceName = "public.event_sponsors_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
    ...
    public EventSponsors tenantId(String tenantId) {
    ...
    public EventSponsors youtubeUrl(String youtubeUrl) {
    ...
    public EventSponsors tiktokUrl(String tiktokUrl) {
