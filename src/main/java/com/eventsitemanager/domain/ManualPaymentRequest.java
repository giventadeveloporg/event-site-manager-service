...
public class ManualPaymentRequest implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "manualPaymentRequestSeq")
    @SequenceGenerator(name = "manualPaymentRequestSeq", sequenceName = "public.manual_payment_request_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
