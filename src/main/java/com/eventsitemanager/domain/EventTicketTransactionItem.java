...
public class EventTicketTransactionItem implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eventTicketTransactionItemSeq")
    @SequenceGenerator(
        name = "eventTicketTransactionItemSeq",
        sequenceName = "public.event_ticket_transaction_item_id_seq",
        allocationSize = 1
    )
    @Column(name = "id")
    private Long id;
