...
public class MembershipSubscription implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "membershipSubscriptionSeq")
    @SequenceGenerator(name = "membershipSubscriptionSeq", sequenceName = "public.membership_subscription_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
