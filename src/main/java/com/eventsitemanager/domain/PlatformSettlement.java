...
public class PlatformSettlement implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "platformSettlementSeq")
    @SequenceGenerator(name = "platformSettlementSeq", sequenceName = "public.platform_settlement_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
