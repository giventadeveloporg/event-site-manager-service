...
public class EventEmails implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eventEmailsSeq")
    @SequenceGenerator(name = "eventEmailsSeq", sequenceName = "public.event_emails_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
