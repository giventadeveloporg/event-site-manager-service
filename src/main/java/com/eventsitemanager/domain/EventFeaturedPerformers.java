...
public class EventFeaturedPerformers implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eventFeaturedPerformersSeq")
    @SequenceGenerator(name = "eventFeaturedPerformersSeq", sequenceName = "public.event_featured_performers_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
