...
public class EventLiveUpdate implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eventLiveUpdateSeq")
    @SequenceGenerator(name = "eventLiveUpdateSeq", sequenceName = "public.event_live_update_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
