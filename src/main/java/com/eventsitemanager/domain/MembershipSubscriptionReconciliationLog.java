...
public class MembershipSubscriptionReconciliationLog implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "membershipSubscriptionReconciliationLogSeq")
    @SequenceGenerator(
        name = "membershipSubscriptionReconciliationLogSeq",
        sequenceName = "public.membership_subscription_reconciliation_log_id_seq",
        allocationSize = 1
    )
    @Column(name = "id")
    private Long id;
