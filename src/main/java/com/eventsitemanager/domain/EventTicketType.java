...
public class EventTicketType implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eventTicketTypeSeq")
    @SequenceGenerator(name = "eventTicketTypeSeq", sequenceName = "public.event_ticket_type_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
