...
public class ClerkSession implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "clerkSessionSeq")
    @SequenceGenerator(name = "clerkSessionSeq", sequenceName = "public.clerk_session_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
