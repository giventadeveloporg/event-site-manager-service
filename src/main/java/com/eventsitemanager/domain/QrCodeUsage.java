...
public class QrCodeUsage implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "qrCodeUsageSeq")
    @SequenceGenerator(name = "qrCodeUsageSeq", sequenceName = "public.qr_code_usage_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
