...
public class DonationTransaction implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "donationTransactionSeq")
    @SequenceGenerator(name = "donationTransactionSeq", sequenceName = "public.donation_transaction_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
