...
public class CommunicationCampaign implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "communicationCampaignSeq")
    @SequenceGenerator(name = "communicationCampaignSeq", sequenceName = "public.communication_campaign_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
