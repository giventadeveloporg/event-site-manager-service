...
public class GivebutterWebhookEvent implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "givebutterWebhookEventSeq")
    @SequenceGenerator(name = "givebutterWebhookEventSeq", sequenceName = "public.givebutter_webhook_event_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
