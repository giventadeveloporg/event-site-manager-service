...
public class EventPollResponse implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eventPollResponseSeq")
    @SequenceGenerator(name = "eventPollResponseSeq", sequenceName = "public.event_poll_response_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
