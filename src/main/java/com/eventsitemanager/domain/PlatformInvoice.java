...
public class PlatformInvoice implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "platformInvoiceSeq")
    @SequenceGenerator(name = "platformInvoiceSeq", sequenceName = "public.platform_invoice_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
