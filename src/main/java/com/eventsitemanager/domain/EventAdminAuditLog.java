...
public class EventAdminAuditLog implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "eventAdminAuditLogSeq")
    @SequenceGenerator(name = "eventAdminAuditLogSeq", sequenceName = "public.event_admin_audit_log_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
