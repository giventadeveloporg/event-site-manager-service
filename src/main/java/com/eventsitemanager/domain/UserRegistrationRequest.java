...
public class UserRegistrationRequest implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "userRegistrationRequestSeq")
    @SequenceGenerator(name = "userRegistrationRequestSeq", sequenceName = "public.user_registration_request_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
