...
import com.eventsitemanager.service.EventSponsorsQueryService;
...
/**
 * REST controller for managing {@link com.eventsitemanager.domain.EventSponsors}.
 */
@RestController
...
public class EventSponsorsResource {
    ...
    public ResponseEntity<EventSponsorsDTO> createEventSponsors(@Valid @RequestBody EventSponsorsDTO eventSponsorsDTO)
        ...
        return ResponseEntity
            ...
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, eventSponsorsDTO.getId().toString()))
    ...
    public ResponseEntity<EventSponsorsDTO> updateEventSponsors(
        ...
        @Valid @RequestBody EventSponsorsDTO eventSponsorsDTO
    ) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, eventSponsorsDTO.getId().toString()))
            .body(eventSponsorsDTO);
    }
    ...
    public ResponseEntity<EventSponsorsDTO> partialUpdateEventSponsors(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody EventSponsorsDTO eventSponsorsDTO
    ) throws URISyntaxException {
