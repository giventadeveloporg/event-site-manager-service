...
import com.eventsitemanager.service.EventSponsorsJoinQueryService;
import com.eventsitemanager.service.EventSponsorsJoinService;
import com.eventsitemanager.service.criteria.EventSponsorsJoinCriteria;
 ...
 * {@link com.eventsitemanager.domain.EventSponsorsJoin}.
 */
@RestController
...
public class EventSponsorsJoinResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<EventSponsorsJoinDTO> createEventSponsorsJoin(@Valid @RequestBody EventSponsorsJoinDTO eventSponsorsJoinDTO)
        ...
        return ResponseEntity
            ...
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, eventSponsorsJoinDTO.getId().toString()))
    ...
    public ResponseEntity<EventSponsorsJoinDTO> updateEventSponsorsJoin(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, eventSponsorsJoinDTO.getId().toString()))
            .body(eventSponsorsJoinDTO);
    }
    ...
    public ResponseEntity<EventSponsorsJoinDTO> partialUpdateEventSponsorsJoin(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody EventSponsorsJoinDTO eventSponsorsJoinDTO
    ) throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, eventSponsorsJoinDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<EventSponsorsJoinDTO>> getEventSponsorsJoinByEventId(@PathVariable("eventId") Long eventId) {
    ...
    public ResponseEntity<List<EventSponsorsJoinDTO>> getEventSponsorsJoinBySponsorId(@PathVariable("sponsorId") Long sponsorId) {
    ...
    public ResponseEntity<EventSponsorsJoinDTO> getEventSponsorsJoinByEventIdAndSponsorId(
        ...
        Optional<EventSponsorsJoinDTO> eventSponsorsJoinDTO = eventSponsorsJoinService.findByEventIdAndSponsorId(eventId, sponsorId);
        return ResponseUtil.wrapOrNotFound(eventSponsorsJoinDTO);
    }
