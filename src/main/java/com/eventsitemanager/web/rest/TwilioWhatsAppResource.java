...
public class TwilioWhatsAppResource {
    ...
    public ResponseEntity<TwilioWhatsAppResponseDTO> checkDeliveryStatus(@PathVariable String tenantId, @PathVariable String messageId) {
    ...
    public ResponseEntity<TwilioTemplateDTO> createTemplate(@PathVariable String tenantId, @Valid @RequestBody TwilioTemplateDTO request)
        ...
        return ResponseEntity.created(new URI("/api/twilio-whatsapp/" + tenantId + "/templates/" + result.getId())).body(result);
    }
    ...
    public ResponseEntity<Map<String, Object>> handleWebhook(@PathVariable String tenantId, @RequestBody Map<String, Object> payload) {
