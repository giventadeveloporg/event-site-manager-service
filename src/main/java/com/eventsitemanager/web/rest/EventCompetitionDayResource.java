...
import com.eventsitemanager.service.EventCompetitionDayQueryService;
import com.eventsitemanager.service.EventCompetitionDayService;
import com.eventsitemanager.service.criteria.EventCompetitionDayCriteria;
...
public class EventCompetitionDayResource {
    ...
    public EventCompetitionDayResource(
        EventCompetitionDayService eventCompetitionDayService,
        EventCompetitionDayRepository eventCompetitionDayRepository,
        EventCompetitionDayQueryService eventCompetitionDayQueryService
    ) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<EventCompetitionDayDTO> update(
        @PathVariable(value = "id", required = false) final Long id,
        @Valid @RequestBody EventCompetitionDayDTO dto
        ...
        return ResponseEntity
            ...
            .body(eventCompetitionDayService.update(dto));
    }

    @PatchMapping(value = "/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<EventCompetitionDayDTO> partialUpdate(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody EventCompetitionDayDTO dto
    ) throws URISyntaxException {
        if (dto.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
    ...
    @GetMapping("")
    public ResponseEntity<List<EventCompetitionDayDTO>> getAll(
        EventCompetitionDayCriteria criteria,
