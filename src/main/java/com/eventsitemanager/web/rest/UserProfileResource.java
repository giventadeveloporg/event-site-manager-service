...
/**
 * REST controller for managing {@link com.eventsitemanager.domain.UserProfile}.
 */
@RestController
...
public class UserProfileResource {
     ...
     * <p>
     * Tenant must be supplied (see {@link com.eventsitemanager.web.filter.TenantContextFilter}): {@code X-Tenant-ID} header,
