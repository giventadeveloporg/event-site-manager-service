...
import com.eventsitemanager.service.TwilioWhatsAppService;
import com.eventsitemanager.service.dto.ConnectionTestResultDTO;
import com.eventsitemanager.service.dto.MessageTemplateDTO;
import com.eventsitemanager.service.dto.TwilioTemplateDTO;
import com.eventsitemanager.service.dto.TwilioWhatsAppBulkRequestDTO;
import com.eventsitemanager.service.dto.TwilioWhatsAppBulkResponseDTO;
import com.eventsitemanager.service.dto.TwilioWhatsAppRequestDTO;
import com.eventsitemanager.service.dto.TwilioWhatsAppResponseDTO;
import com.eventsitemanager.service.dto.WhatsAppAnalyticsDTO;
...
public class WhatsAppResource {
    ...
    public ResponseEntity<TwilioWhatsAppResponseDTO> sendMessage(@Valid @RequestBody TwilioWhatsAppRequestDTO request) {
        ...
        try {
            ...
            if (request.getTo() == null || request.getTo().trim().isEmpty()) {
                throw new BadRequestAlertException("Recipient phone number is required", ENTITY_NAME, "recipientrequired");
            }

            // Validate message content
            if (request.getMessageBody() == null || request.getMessageBody().trim().isEmpty()) {
                throw new BadRequestAlertException("Message body is required", ENTITY_NAME, "messagebodyrequired");
            }

            TwilioWhatsAppResponseDTO result = twilioWhatsAppService.sendMessage(request.getTenantId(), request);
            ...
            throw new BadRequestAlertException("Failed to send WhatsApp message: " + e.getMessage(), ENTITY_NAME, "sendmessageerror");
        }
    }
    ...
    public ResponseEntity<TwilioWhatsAppBulkResponseDTO> sendBulkMessages(@Valid @RequestBody TwilioWhatsAppBulkRequestDTO request) {
        ...
        try {
            ...
            if (request.getRecipients() == null || request.getRecipients().isEmpty()) {
                throw new BadRequestAlertException("Recipients list is required", ENTITY_NAME, "recipientsrequired");
            }
            ...
            TwilioWhatsAppBulkResponseDTO result = twilioWhatsAppService.sendBulkMessages(request.getTenantId(), request);

            LOG.info(
                "Successfully sent bulk WhatsApp messages for tenant: {}, sent: {}, failed: {}",
                request.getTenantId(),
                result.getTotalSent(),
    ...
    public ResponseEntity<TwilioWhatsAppResponseDTO> checkDeliveryStatus(@PathVariable String messageId, @RequestParam String tenantId) {
        LOG.debug("REST request to check delivery status for messageId: {}, tenantId: {}", messageId, tenantId);

        try {
            // Validate message ID
            if (messageId == null || messageId.trim().isEmpty()) {
                throw new BadRequestAlertException("Message ID is required", ENTITY_NAME, "messageidrequired");
            }
            ...
            LOG.debug("Retrieved delivery status for messageId: {}, tenantId: {}, status: {}", messageId, tenantId, result.getStatus());
            return ResponseEntity.ok(result);
        } catch (RuntimeException e) {
            LOG.error("Failed to check delivery status for messageId: {}, tenantId: {}, error: {}", messageId, tenantId, e.getMessage(), e);
            throw new BadRequestAlertException(
    ...
    public ResponseEntity<ConnectionTestResultDTO> testConnection(@RequestParam String tenantId) {
        ...
        try {
            ...
            LOG.info("Connection test completed for tenant: {}, success: {}", tenantId, result.isSuccess());
            return ResponseEntity.ok(result);
        } catch (RuntimeException e) {
            LOG.error("Failed to test connection for tenant: {}, error: {}", tenantId, e.getMessage(), e);
            throw new BadRequestAlertException("Failed to test connection: " + e.getMessage(), ENTITY_NAME, "testconnectionerror");
        }
    }
    ...
    public ResponseEntity<List<TwilioTemplateDTO>> getTemplates(@RequestParam String tenantId) {
        ...
        try {
            ...
            LOG.error("Failed to get templates for tenant: {}, error: {}", tenantId, e.getMessage(), e);
            throw new BadRequestAlertException("Failed to get templates: " + e.getMessage(), ENTITY_NAME, "gettemplateserror");
        }
    }
    ...
    public ResponseEntity<TwilioTemplateDTO> createTemplate(@RequestParam String tenantId, @Valid @RequestBody TwilioTemplateDTO request) {
        ...
        try {
            ...
            if (request.getName() == null || request.getName().trim().isEmpty()) {
                throw new BadRequestAlertException("Template name is required", ENTITY_NAME, "templatenamerequired");
            }

            if (request.getContent() == null || request.getContent().trim().isEmpty()) {
                throw new BadRequestAlertException("Template content is required", ENTITY_NAME, "templatecontentrequired");
            }

            TwilioTemplateDTO template = twilioWhatsAppService.createTemplate(tenantId, request);

            LOG.info("Created template for tenant: {}, templateId: {}", tenantId, template.getId());
            return ResponseEntity.ok(template);
        } catch (RuntimeException e) {
            LOG.error("Failed to create template for tenant: {}, error: {}", tenantId, e.getMessage(), e);
            throw new BadRequestAlertException("Failed to create template: " + e.getMessage(), ENTITY_NAME, "createtemplateerror");
        }
    }
    ...
    public ResponseEntity<WhatsAppAnalyticsDTO> getAnalytics(
        ...
        LOG.debug("REST request to get WhatsApp analytics for tenant: {}, from: {}, to: {}", tenantId, fromDate, toDate);
        ...
        try {
            ...
            throw new BadRequestAlertException("Failed to get analytics: " + e.getMessage(), ENTITY_NAME, "getanalyticserror");
        }
    }
}
