...
import com.eventsitemanager.service.EventCompetitionResultQueryService;
...
public class EventCompetitionResultResource {
    ...
    public EventCompetitionResultResource(
        EventCompetitionResultService eventCompetitionResultService,
        EventCompetitionResultRepository eventCompetitionResultRepository,
        EventCompetitionResultQueryService eventCompetitionResultQueryService
    ) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<EventCompetitionResultDTO> update(
        @PathVariable(value = "id", required = false) final Long id,
        @Valid @RequestBody EventCompetitionResultDTO dto
        ...
        return ResponseEntity
            ...
            .body(eventCompetitionResultService.update(dto));
    }

    @PatchMapping(value = "/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<EventCompetitionResultDTO> partialUpdate(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody EventCompetitionResultDTO dto
    ) throws URISyntaxException {
        if (dto.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
    ...
    @GetMapping("")
    public ResponseEntity<List<EventCompetitionResultDTO>> getAll(
        EventCompetitionResultCriteria criteria,
