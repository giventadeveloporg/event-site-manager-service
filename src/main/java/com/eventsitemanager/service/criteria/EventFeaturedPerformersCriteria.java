 ...
 * {@link com.eventsitemanager.domain.EventFeaturedPerformers} entity. This class
 * is used
 * in {@link com.eventsitemanager.web.rest.EventFeaturedPerformersResource} to
...
public class EventFeaturedPerformersCriteria implements Serializable, Criteria {
    ...
    public EventFeaturedPerformersCriteria(EventFeaturedPerformersCriteria other) {
        ...
        this.performanceDurationMinutes = other.performanceDurationMinutes == null ? null : other.performanceDurationMinutes.copy();
