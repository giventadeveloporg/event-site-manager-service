...
public interface EventFeaturedPerformersService {
    ...
    /**
     * Get all tenant-level featured performers (not associated with any event).
     *
     * @param tenantId the tenant ID.
     * @return the list of tenant-level featured performers.
     */
    List<EventFeaturedPerformersDTO> findAllTenantLevelFeaturedPerformers(String tenantId);

    /**
     * Get all featured performers available for association with a specific event.
     * This includes tenant-level performers and performers from other events.
     *
     * @param tenantId the tenant ID.
     * @param eventId  the event ID to exclude.
     * @return the list of available featured performers.
     */
    List<EventFeaturedPerformersDTO> findAvailableFeaturedPerformersForEvent(String tenantId, Long eventId);

    /**
     * Disassociate a featured performer from its event (set event_id to null).
     *
     * @param id the id of the featured performer to disassociate.
     * @return the updated featured performer.
     */
    EventFeaturedPerformersDTO disassociateFromEvent(Long id);

    /**
     * Associate a featured performer with a specific event.
     *
     * @param id      the id of the featured performer to associate.
     * @param eventId the id of the event to associate with.
     * @return the updated featured performer.
     */
    EventFeaturedPerformersDTO associateWithEvent(Long id, Long eventId);
}
