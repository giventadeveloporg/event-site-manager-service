package com.eventsitemanager.service.payment.orchestration;
...
public class PaymentOrchestrationService {
    ...
    public void processGivebutterWebhook(
        com.eventsitemanager.service.payment.adapter.givebutter.dto.GivebutterWebhookEvent event,
        String tenantId
    ) throws PaymentException {
    ...
    private void createTicketTransactionForGivebutter(
        ...
        try {
            ...
            com.eventsitemanager.service.payment.adapter.givebutter.dto.GivebutterDonation donation = event.getDonation();
