...
import com.eventsitemanager.service.payment.StripeSubscriptionWebhookHandler;
import com.eventsitemanager.service.payment.TicketGenerationService;
import com.eventsitemanager.service.payment.dto.PaymentItem;
...
public class StripePaymentAdapter implements PaymentService {
    ...
    private final com.eventsitemanager.service.payment.PaymentProviderConfigService configService;
    ...
    public StripePaymentAdapter(
        ...
        com.eventsitemanager.service.payment.PaymentProviderConfigService configService
    ) {
    ...
    private void handlePaymentIntentSucceeded(Event event, Map<String, Object> result) {
        ...
        if (metadataTenantId != null && !metadataTenantId.isEmpty()) {
            ...
            if (!metadataTenantId.equals(transactionTenantId)) {
                ...
                com.eventsitemanager.security.TenantContext.setCurrentTenant(metadataTenantId);
            }
        }
