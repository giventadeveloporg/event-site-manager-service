...
public class EventSponsorsJoinServiceImpl implements EventSponsorsJoinService {
    ...
    public List<EventSponsorsJoinDTO> findByEventId(Long eventId) {
        ...
        return eventSponsorsJoinRepository.findByEventId(eventId).stream().map(eventSponsorsJoinMapper::toDto).collect(Collectors.toList());
    }
    ...
    public Optional<EventSponsorsJoinDTO> findByEventIdAndSponsorId(Long eventId, Long sponsorId) {
        ...
        return eventSponsorsJoinRepository.findByEventIdAndSponsorId(eventId, sponsorId).map(eventSponsorsJoinMapper::toDto);
    }
