...
import com.eventsitemanager.service.EventSponsorsService;
...
public class EventSponsorsServiceImpl implements EventSponsorsService {
    ...
    public EventSponsorsServiceImpl(EventSponsorsRepository eventSponsorsRepository, EventSponsorsMapper eventSponsorsMapper) {
    ...
    public List<EventSponsorsDTO> findByType(String type) {
        ...
        return eventSponsorsRepository.findByType(type).stream().map(eventSponsorsMapper::toDto).collect(Collectors.toList());
    }
    ...
    public List<EventSponsorsDTO> findByIsActive(Boolean isActive) {
        ...
        return eventSponsorsRepository.findByIsActive(isActive).stream().map(eventSponsorsMapper::toDto).collect(Collectors.toList());
    }
    ...
    public List<EventSponsorsDTO> findByNameAndType(String name, String type) {
        ...
        return eventSponsorsRepository.findByNameAndType(name, type).stream().map(eventSponsorsMapper::toDto).collect(Collectors.toList());
    }
