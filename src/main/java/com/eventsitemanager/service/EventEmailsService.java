...
/**
 * Service Interface for managing {@link com.eventsitemanager.domain.EventEmails}.
 */
public interface EventEmailsService {
    ...
    /**
     * Get all tenant-level emails (not associated with any event).
     *
     * @param tenantId the tenant ID.
     * @return the list of tenant-level emails.
     */
    List<EventEmailsDTO> findAllTenantLevelEmails(String tenantId);

    /**
     * Get all emails available for association with a specific event.
     * This includes tenant-level emails and emails from other events.
     *
     * @param tenantId the tenant ID.
     * @param eventId  the event ID to exclude.
     * @return the list of available emails.
     */
    List<EventEmailsDTO> findAvailableEmailsForEvent(String tenantId, Long eventId);

    /**
     * Disassociate an email from its event (set event_id to null).
     *
     * @param id the id of the email to disassociate.
     * @return the updated email.
     */
    EventEmailsDTO disassociateFromEvent(Long id);

    /**
     * Associate an email with a specific event.
     *
     * @param id      the id of the email to associate.
     * @param eventId the id of the event to associate with.
     * @return the updated email.
     */
    EventEmailsDTO associateWithEvent(Long id, Long eventId);
}
