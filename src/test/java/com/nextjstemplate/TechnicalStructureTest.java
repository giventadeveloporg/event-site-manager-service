...
@AnalyzeClasses(packagesOf = NextjsTemplateBootApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(alwaysTrue(), belongToAnyOf(
            com.nextjstemplate.config.Constants.class,
            com.nextjstemplate.config.ApplicationProperties.class
        ));
}
