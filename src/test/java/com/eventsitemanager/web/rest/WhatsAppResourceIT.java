...
class WhatsAppResourceIT {
    ...
    void testSendMessage() throws Exception {
        ...
        restWhatsAppMockMvc
            .perform(
                post("/api/whatsapp/send-message").contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(request))
            )
    ...
    void testSendBulkMessages() throws Exception {
        ...
        restWhatsAppMockMvc
            .perform(
                post("/api/whatsapp/send-bulk").contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(request))
            )
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void testCheckDeliveryStatus() throws Exception {
        restWhatsAppMockMvc
            .perform(get("/api/whatsapp/delivery-status/test-message-id").param("tenantId", "test-tenant-001"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void testTestConnection() throws Exception {
        restWhatsAppMockMvc
            .perform(get("/api/whatsapp/test-connection").param("tenantId", "test-tenant-001"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void testGetTemplates() throws Exception {
        restWhatsAppMockMvc
            .perform(get("/api/whatsapp/templates").param("tenantId", "test-tenant-001"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void testGetAnalytics() throws Exception {
        restWhatsAppMockMvc
            .perform(get("/api/whatsapp/analytics").param("tenantId", "test-tenant-001"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.tenantId").value("test-tenant-001"))
