...
show_status() {
    ...
    echo -e "${GREEN}✅ pgAdmin:${NC} http://localhost:${PGADMIN_PORT} (${PGADMIN_DEFAULT_EMAIL:-admin@local.com}/${PGADMIN_DEFAULT_PASSWORD:-admin})"
    echo -e "${GREEN}✅ Redis Commander:${NC} http://localhost:${REDIS_COMMANDER_PORT} (${REDIS_COMMANDER_USER:-admin}/${REDIS_COMMANDER_PASSWORD:-admin})"
